...
- [x] 1. Set up monorepo structure and shared types
  ...
  - [x] 1.2 Define shared data contract interfaces (`packages/types`)
  ...
  - [x] 1.3 Implement data contract validators (`packages/types/validators`)
  ...
  - [x]* 1.4 Write property tests for data contract validators
...
- [x] 2. Implement MIDI note extraction (Stage B)
  - [x] 2.1 Implement MIDI parser (`packages/note-extractor`)
  ...
  - [x]* 2.2 Write property tests for MIDI velocity normalization and ID uniqueness
...
- [x] 3. Implement musical mapping (Stage C)
  - [x] 3.1 Implement pitch-to-position mapping (`packages/musical-mapper`)
  ...
  - [x] 3.2 Implement full musical mapper with note filtering
  ...
  - [x]* 3.3 Write property tests for musical mapper
...
- [x] 4. Checkpoint - Core data pipeline
  - Ensure all tests pass, ask the user if questions arise.
  - Verify: MIDI file → NoteEvent[] → ChoreographyTarget[] works end-to-end with a test MIDI file.

- [x] 5. Implement trajectory solver (Stage D — Core IP)
  - [x] 5.1 Implement ballistic arc calculator
  ...
  - [x]* 5.2 Write property tests for ballistic arc calculator
  ...
  - [x] 5.3 Implement trajectory chaining solver
  ...
  - [x]* 5.4 Write property tests for trajectory solver
...
- [x] 6. Checkpoint - Solver correctness
  - Ensure all tests pass, ask the user if questions arise.
  - Verify: ChoreographyTarget[] → ObjectTrajectory with timing within tolerance.

- [x] 7. Implement simulation and rendering (Stage E)
  - [x] 7.1 Implement frame renderer (`packages/renderer`)
...
- [x] 8. Implement video export (Stage F)
  - [x] 8.1 Implement ffmpeg video exporter (`packages/video-export`)
...
- [x] 9. Implement CLI entry point and wire pipeline
  - [x] 9.1 Implement CLI argument parser (`packages/cli`)
  ...
  - [x] 9.2 Wire complete pipeline in CLI main function
  ...
  - [x] 9.3 Add npm bin script and build configuration
...
- [x] 10. Checkpoint - End-to-end M1
  - Ensure all tests pass, ask the user if questions arise.
  - Verify: `motionscore test.mid -o output.mp4` produces a valid video with synced impacts.

- [x] 11. Implement audio transcription support (M2)
  - [x] 11.1 Implement Basic Pitch subprocess wrapper
  ...
  - [x] 11.2 Wire audio transcription into note extractor
  ...
  - [x]* 11.3 Write integration test for audio transcription path
...
- [x] 12. Final checkpoint - M1 + M2 complete
  - Ensure all tests pass, ask the user if questions arise.
